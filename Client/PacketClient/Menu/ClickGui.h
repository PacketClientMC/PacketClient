...
private:
	...
	static void renderPacketCategory(Category category, MC_Color categoryMC_Color);
	static void renderVapeCategory(Category category);
	static void renderAstolfoCategory(Category category, MC_Color categoryMC_Color, MC_Color categoryMC_Color2);
