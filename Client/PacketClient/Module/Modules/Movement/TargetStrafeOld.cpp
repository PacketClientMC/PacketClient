...
void TargetStrafeOld::onMove(MoveInputHandler* input) {
...
void findEntityTSOLD(Entity* currentEntity, bool isRegularEntity) {
...
void TargetStrafeOld::onTick(GameMode* gm) {
	if (autoplayMode) {
		range = 500;
} else {
	range = 10;
...
void TargetStrafeOld::onSendPacket(Packet* packet) {
}

void TargetStrafeOld::onPostRender(MinecraftUIRenderContext* renderCtx) {
}

void TargetStrafeOld::onPreRender(MinecraftUIRenderContext* renderCtx) {
}