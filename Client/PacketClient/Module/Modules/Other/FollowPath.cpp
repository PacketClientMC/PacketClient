...
void FollowPath::startSearch(vec3_ti startNode, BlockSource* region, float searchTimeout, function<void(bool, Path)> callback) {
	if (pathFinder) {
...
void FollowPath::onTick(GameMode* mode) {
...
void FollowPath::onMove(MoveInputHandler* handler) {
