...
Interface::Interface() : IModule(0, Category::VISUAL, "Displays the HUD") {
	registerEnumSetting("MC_Color", &color, 0);
...
void Interface::onTick(GameMode* gm) {
	shouldHide = true;
}

void Interface::onPreRender(MinecraftUIRenderContext* renderCtx) {
}

void Interface::onPostRender(MinecraftUIRenderContext* renderCtx) {
