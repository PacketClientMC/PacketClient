...
public:
	bool canUseKeys; //0xC8
private:
	char pad_0xC9[0xD97]; //0xC9
public:
	FontRepository* fontRepository; //0xE60
private:
	char pad_0xE68[0x8]; //0xE68
public:
	Font* mcFont; //0xE70
...
public:
	vec2_t windowSizeReal;    // 0x0030
	vec2_t windowSizeReal2;   // 0x0038
	union {
		struct {
			float widthGame;   // 0x0040
			float heightGame;  // 0x0044
		};
		vec2_t windowSize;  // 0x0040
	};
private:
...
private:
	char pad_0x8[0x80]; //0x8
public:
	class HitDetectSystem* hitDetectSystem; //0x88
private:
	char pad_0x90[0x18]; //0x90
public:
...
private:
	...
	virtual __int64 removed(void);
	virtual __int64 removed2(void) const;
...
private:
	...
	virtual void subFunction8(void) const;
	virtual void subFunction9(void) const;
	virtual void subFunction10(void) const;
	virtual void subFunction11(void) const;
	virtual void subFunction12(void) const;
	virtual void subFunction13(void) const;
	virtual void subFunction14(void) const;
...
public:
	...
	virtual __int64 getShaderMC_Color(void);
	virtual __int64 getDarkShaderMC_Color(void);
