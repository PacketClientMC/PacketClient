...
public:
	...
	virtual __int64 getItemMC_Color(void);                                                                                                    // 16
	...
	virtual __int64 appendFormattedHovertext(ItemStack const&, PointingStruct&, std::string&, bool);                                  // 54
	...
	virtual bool isMultiMC_ColorTinted(ItemStack const&);                                                                                  // 65
	virtual __int64 getMC_Color();                                                                                                            // 66
	virtual bool hasCustomMC_Color(ItemStack const&);                                                                                      // 67
	virtual bool hasCustomMC_Color(CompoundTag const*);                                                                                      // 68
	virtual __int64 clearMC_Color(ItemStack&);                                                                                             // 69
	virtual __int64 clearMC_Color(CompoundTag*);                                                                                             // 70
	virtual __int64 setMC_Color();                                                                                                            // 71
	virtual __int64 getBaseMC_Color(ItemStack const&);                                                                                     // 72
	virtual __int64 getSecondaryMC_Color(ItemStack const&);                                                                                // 73
	...
	virtual __int64 dispense(BlockSource&, __int64, int, vec3_t const&, unsigned char);                                                // 80
	virtual __int64 useTimeDepleted(ItemStack&, PointingStruct*, Player*);                                                          // 81
	...
	virtual __int64 hitBlock(ItemStack&, Block const&, vec3_ti const&, Entity&);                                                 // 86
	...
	virtual __int64 inventoryTick(ItemStack&, PointingStruct&, Entity&, int, bool);                                                 // 96
	virtual __int64 refreshedInContainer(ItemStack const&, PointingStruct&);                                                           // 97
	virtual __int64 getCooldownType(void);                                                                                                 // 98
	virtual __int64 getCooldownTime(void);                                                                                                 // 99
	virtual __int64 fixupCommon(ItemStack&);                                                                                            // 100
	virtual __int64 fixupCommon(ItemStack&, PointingStruct&);                                                                          // 101
	...
	virtual __int64 _checkUseOnPermissions(Entity&, ItemStack&, unsigned char const&, vec3_ti const&);                             // 124
	virtual __int64 _calculatePlacePos(ItemStack&, Entity&, unsigned char&, vec3_ti&);                                             // 125
	virtual __int64 _useOn(ItemStack&, Entity&, vec3_ti, unsigned char, float, float, float);                                        // 126
