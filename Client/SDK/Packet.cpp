...
LevelSoundEventPacket::LevelSoundEventPacket() {
	...
	if (LevelSoundEventPacketVtable == 0x0) {
		...
		LevelSoundEventPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
...
PlayerAuthInputPacket::PlayerAuthInputPacket() {
	...
	if (PlayerAuthInputPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		PlayerAuthInputPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
...
MobEquipmentPacket::MobEquipmentPacket() {
	...
	if (MobEquipmentPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		MobEquipmentPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
...
InventoryTransactionPacket::InventoryTransactionPacket() {
	...
	if (InventoryTransactionPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		InventoryTransactionPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (InventoryTransactionPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(InventoryTransactionPacket));
...
MovePlayerPacket::MovePlayerPacket() {
	...
	if (movePlayerPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		movePlayerPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (movePlayerPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(MovePlayerPacket));
	vTable = movePlayerPacketVtable;
}

MovePlayerPacket::MovePlayerPacket(LocalPlayer* player, vec3_t pos) {
	static uintptr_t** movePlayerPacketVtable = 0x0;
	if (movePlayerPacketVtable == 0x0) {
		uintptr_t sigOffset = FindSignature("48 8D 05 ? ? ? ? 49 89 40 08 48 8B 47 30");
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
...
MovePlayerPacket::MovePlayerPacket(LocalPlayer* player, vec3_t pos, bool onground = true) {
	static uintptr_t** movePlayerPacketVtable = 0x0;
	if (movePlayerPacketVtable == 0x0) {
		uintptr_t sigOffset = FindSignature("48 8D 05 ? ? ? ? 49 89 40 08 48 8B 47 30");
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
...
PlayerActionPacket::PlayerActionPacket() {
	...
	if (playerActionPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		playerActionPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
...
SubChunkRequestPacket::SubChunkRequestPacket() {
	...
	if (subChunkRequestPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		subChunkRequestPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (subChunkRequestPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(SubChunkRequestPacket));
...
EmotePacket::EmotePacket() {
	...
	if (emotePacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		emotePacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (emotePacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(EmotePacket));
...
AnimatePacket::AnimatePacket() {
	...
	if (animatePacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		animatePacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (animatePacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(AnimatePacket));
...
NPCRequestPacket::NPCRequestPacket() {
	...
	if (npcRequestPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		npcRequestPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (npcRequestPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(NPCRequestPacket));
...
PlayerSkinPacket::PlayerSkinPacket() {
	...
	if (playerSkinPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		playerSkinPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (playerSkinPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(PlayerSkinPacket));
...
NetworkLatencyPacket::NetworkLatencyPacket() {
	...
	memset(this, 0, sizeof(NetworkLatencyPacket));
...
TextPacket::TextPacket() {
	...
	if (textPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		textPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (textPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(TextPacket));
	vTable = textPacketVtable;

	messageType = 1;  // TYPE_CHAT
}

InteractPacket::InteractPacket(/*enum InteractPacket::Action, class ActorRuntimeID, vec3_t const&*/) {
	...
	if (interactPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		interactPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (interactPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(InteractPacket));
...
ActorEventPacket::ActorEventPacket(uint64_t entityRuntimeId, char eventId, int16_t itemId) {
	...
	if (actorEvenPacketVtable == 0x0) {
		...
		int offset = *reinterpret_cast<int*>(sigOffset + 3);
		actorEvenPacketVtable = reinterpret_cast<uintptr_t**>(sigOffset + offset + 7);
#ifdef _DEBUG
		if (actorEvenPacketVtable == 0x0 || sigOffset == 0x0)
			__debugbreak();
#endif
	}
	memset(this, 0, sizeof(ActorEventPacket));
