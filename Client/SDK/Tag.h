...
public:
	...
	void read(std::string& string) {
		static constexpr int ARRAY_START = 0;    // Parsing context
		static constexpr int ARRAY_ELEMENT = 1;  // Parsing context
		int context = ARRAY_START;
		std::string tmpval = "";
		int scope = 0;
		bool inString = false;
...
public:
	...
	void read(std::string& string) {
		static constexpr int COMPOUND_START = 0;       // Parsing context
		static constexpr int COMPOUND_PAIR_KEY = 1;    // Parsing context
		static constexpr int COMPOUND_PAIR_VALUE = 2;  // Parsing context

		int context = COMPOUND_START;
