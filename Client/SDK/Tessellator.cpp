...
mce::Mesh* BlockTessellator::getMeshForBlockInWorld(Tessellator* t, Block* block, vec3_ti& pos) {
	using BT_getMeshForBlockInWorld_t = mce::Mesh* (*)(BlockTessellator*, Tessellator*, Block*, vec3_ti&, int, __int64);
