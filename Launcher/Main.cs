...
namespace PacketLauncher
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            if (Version.Parse(version) > GetVersion())
                if (MessageBox.Show("New update available! Do you want to update now?", null, MessageBoxButtons.YesNo) == DialogResult.Yes) UpdateLauncher();
